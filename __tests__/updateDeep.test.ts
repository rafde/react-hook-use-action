...
describe('dispatch.cta.updateDeep', () => {
	...
	test('updates a deep property with nested partial', () => {
		...
		act( () => {
			result.current[ 1 ].cta.updateDeep( changes, );
		}, );
	...
	test('updates a deep property with array of keys and partial', () => {
		...
		act( () => {
			result.current[ 1 ].cta.updateDeep( ['user', 'profile', 'settings', 'notifications'],  changes,);
		}, );
	...
	test('updates a deep property with array of one key and value', () => {
		...
		act( () => {
			result.current[ 1 ].cta.updateDeep( ['[friends]'],  changes,);
		}, );
	...
	test('updates a deep property with array of keys and value', () => {
		...
		act( () => {
			result.current[ 1 ].cta.updateDeep( ['user', 'profile', 'settings', 'notifications', 'email'],  changes,);
		}, );
	...
	test('updates a deep property with deep string prop with dot and value', () => {
		...
		act( () => {
			result.current[ 1 ].cta.updateDeep( 'user', changes,);
		}, );
	...
	test('updates a deep property with deep string prop with dot and value', () => {
		...
		act( () => {
			result.current[ 1 ].cta.updateDeep( 'user.profile.name', changes,);
		}, );
	...
	test('updates key 1 value', () => {
		...
		act( () => {
			result.current[ 1 ].cta.updateDeep(1, changes);
		}, );
