...
function $f0f97a638af05ef2$var$typeResult(param) {
    ...
    switch(type){
        case 'replace':
            return $f0f97a638af05ef2$var$_replaceCurrent(ctaReducerState, next, compare);
        case 'replaceInitial':
        ...
        case 'updateInitial':
            return $f0f97a638af05ef2$var$_updateInitial(ctaReducerState, next, compare);
        default:
            return $f0f97a638af05ef2$var$_updateCurrent(ctaReducerState, next, compare);
    }
}
...
//# sourceMappingURL=ctaReducer.05e36ce2.js.map
